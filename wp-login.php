<!DOCTYPE html>
	...
	<title>Log In &lsaquo; Prep Your Meal &#8212; WordPress</title>
...
<link rel='stylesheet' id='login-css'  href='/wp-admin/css/login.min.css?ver=5.1.1' type='text/css' media='all' />
	...
	<body class="login login-action-login wp-core-ui  locale-en-ca">
		<div id="login">
		<h1><a href="https://en-ca.wordpress.org/" title="Powered by WordPress">Powered by WordPress</a></h1>
	...
	<p class="submit">
		<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In" />
				<input type="hidden" name="redirect_to" value="http://localhost:8888/prepyourmeal/wp-admin/" />
	...
	d.select();
		...
		&larr; Back to Prep Your Meal	</a></p>
